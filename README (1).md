...
| Nama | NIM | Peran |
|---|---|---|
| *(Anggota 1)* | *(NIM)* | Backend Developer |
| *(Anggota 2)* | *(NIM)* | Frontend Developer |
| *(Anggota 3)* | *(NIM)* | Database & Security |
| *(Anggota 4)* | *(NIM)* | Documentation |
| *(Anggota 5)* | *(NIM)* | Testing & QA |
| *(Anggota 6)* | *(NIM)* | Project Manager |
